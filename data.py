...
def load_data(cfg: dict, index_num : int) -> (Dataset, Dataset, Optional[Dataset], Vocabulary, Vocabulary):
    """
...
class SignProdDataset(data.Dataset):
    ...
    def __init__(self, index_num, path, exts, fields, trg_size, skip_frames=1, **kwargs):
        ...
        with io.open(src_path, mode='r', encoding='utf-8') as src_file, \
            ...
            src_line = src_file.readlines()[index_num]
            trg_line = trg_file.readlines()[index_num]
            files_line = files_file.readlines()[index_num]
